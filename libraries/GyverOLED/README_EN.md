# This library is not the original GyverOLED; some parameters have been modified for this project.
# The line spacing has been increased for better readability (fits 5 lines of 21 characters each, instead of the standard 7 lines of 21 characters).
